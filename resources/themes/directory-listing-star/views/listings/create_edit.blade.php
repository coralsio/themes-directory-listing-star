...
@section('content')
    <main id="listar-main" class="listar-main listar-haslayout">
        ...
        <div id="listar-content" class="listar-content">
            ...
            @component('components.box')
                {!! CoralsForm::openForm($listing, ['url' => url($resource_url.'/'.$listing->hashed_id),'method'=>$listing->exists?'PUT':'POST','files'=>true,'class'=>'ajax-form listar-formtheme listar-formaddlisting']) !!}
