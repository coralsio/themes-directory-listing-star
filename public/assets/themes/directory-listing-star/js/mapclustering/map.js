...
function sp_init_map_script(_map_id) {
    var directory_path = 'assets/themes/directory-listing-star/';
    ...
    if (locations.length > 0) {
        ...
        for (var i = 0; i < locations.length; i++) {
            ...
            // infobox_html += '<div class="listar-themepostfoot"><a class="listar-location" href="javascript:void(0);"><i class="icon-icons74"></i><em>New York</em></a><div class="listar-postbtns"><a class="listar-btnquickinfo listar-liked" href="javascript:void(0);"><i class="icon-heart-active"></i></a></div></div>';
            // infobox_html += '</div>';
